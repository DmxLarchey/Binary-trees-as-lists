...
Require Import List Arith Omega Wellfounded Init Datatypes.
...
Proof.
  ...
  intros H1 H2. injection H2. intros H3 H4. 
  subst x; split; injection H1; intros H5.
  f_equal; revert H3; revert H5; destruct H1; destruct H2;revert l2. apply IH.
  revert H3. revert H5. destruct H1. destruct H2. revert l2. apply IH.
Qed.
...
Section prefix. (* as an inductive predicate *)
  ...
  Proof.
    ...
    intro H. left.
    apply in_prefix_0.
    destruct r1 as [ | y r1 ]; intros.
    right.
    apply in_prefix_0.

    apply prefix_inv in H as H0.
