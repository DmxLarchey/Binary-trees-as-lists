...
Notation u00f8 := bt0.       (* for a nicer display *)
...
Inductive bt_mirror : bt -> bt -> Prop :=
  | in_bt_mirror_0 : bt_mirror u00f8 u00f8
...
Eval compute in [[ <<u00f8,u00f8>> ]].
Eval compute in [[ <<u00f8,<<u00f8,u00f8>>>> ]].
